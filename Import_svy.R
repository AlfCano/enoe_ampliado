...
# Salvar modificaciones en caja
#local({
# ## Computar
# save(caja,
# 	file="/home/cano/git/enoe_ampliado/Tasas/caja/caja.RData")
#
# ## Imprimir el resultado
# rk.header ("Guardar objetos R", parameters=list("Nombre de archivo"="/home/cano/git/enoe/Tasas/caja/caja_ampli.RData",
# 	"Objeto"="caja"))
# })
...
# Revisar 1t 2022 Codificación tiene problemas en des.1 No es necesario, se ha arreglado en 1t 2022
